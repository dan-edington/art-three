...
void main() {
  // Normals need updating because vertices were changed in vertex shader
  // Creates FACE NORMALS which look flat
  ...
  specular += iblSample * 0.25;
  specular *= fresnel;

  lighting = ambient * 0.1 + hemi * 0.1 + diffuse * 0.5;
